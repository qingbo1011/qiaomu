...
type QueenNacosRegister struct {
	cli naming_client.INamingClient
}

func (r *QueenNacosRegister) CreateCli(option Option) error {
	// 创建clientConfig的另一种方式
	//clientConfig := *constant.NewClientConfig(
	//	constant.WithNamespaceId(""), //当namespace是public时，此处填空字符串。
	//	constant.WithTimeoutMs(5000),
...
func (r *QueenNacosRegister) RegisterService(serviceName string, host string, port int) error {
...
func (r *QueenNacosRegister) Close() error {
	return nil
}
